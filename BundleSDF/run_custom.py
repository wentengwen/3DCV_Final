...
def run_one_video(video_dir='/home/bowen/debug/2022-11-18-15-10-24_milk', out_folder='/home/bowen/debug/bundlesdf_2022-11-18-15-10-24_milk/', use_segmenter=False, use_gui=False):
  ...
  if args.num_frames < 0:
    args.num_frames = len(reader.color_files)
  for i in range(0,min(len(reader.color_files), args.num_frames),args.stride):
...
if __name__=="__main__":
  ...
  parser.add_argument('--shorter_side', type=int, default=192)
  parser.add_argument('--num_frames', type=int, default=-1, help='number of frames to process; defult: all frames')
